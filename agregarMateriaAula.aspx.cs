...
public partial class agregarMateriaAula : System.Web.UI.Page
{
    Usuarios us;
    DataSet ds = new DataSet();
    DataSet ds2 = new DataSet();
    DataSet validacion = new DataSet();
    DataSet validacion2 = new DataSet();
    ...
    protected void agregaBtn_Click(object sender, EventArgs e)
    {
        ...
        string idAulaMateria = Convert.ToString(rnd.Next(1147989));
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                if (ds2.Tables[0].Rows.Count != 0)
                {
                    ...
                    validacion2 = us.ValidacionHorarioMateria2(dias, codigoAula, horaIni);
                    if (validacion.Tables[0].Rows.Count == 0 && validacion2.Tables[0].Rows.Count == 0)
                    {
                        ...
                        if(ds.Tables[0].Rows.Count != 0 && ds2.Tables[0].Rows.Count != 0)
                        {
                            ...
                            {
                                respuesta = us.agregarMateriaAula(idAulaMateria, idInscripcion, codigoAula, dias, horaIni, horaFin);
                                if (respuesta == true)
                                {
