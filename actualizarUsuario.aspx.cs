...
public partial class actualizarUsuario : System.Web.UI.Page
{
    ...
    protected void ActualizarBtn_Click(object sender, EventArgs e)
    {
        ...
        if (idUserTxT.Text != "" && contraseñaTxt.Text != "" && nivelTxT.Text != "")
        {
            ...
            try
            {
                resp = us.actualizarUsuario(idUser, pass, nivel);
                if (resp == true)
                {
                    mensaje = "<div class='card-panel green lighten-2'>";
                    mensaje += "<span class='white-text center-align'>Usuario Actualizado Correctamente</span>";
                    mensaje += "</div>";
                ...
                else
                {
                    ...
                    mensaje += "<span class='white-text center-align'>Usuario No Actualizado intente nuevamente</span>";
                    mensaje += "</div>";
                    mensajeLbl.Text = mensaje;
                }
            }
