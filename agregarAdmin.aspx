<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="agregarAdmin.aspx.cs" Inherits="agregarAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoContent" Runat="Server">
    <div class="row">
        <div class="col s12">
            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/mantenimientoAdmin.aspx">Regresar</asp:LinkButton>
        </div>
    </div>
    <div class="row">
        <div class="input-field col s12">
            <label for="idAdminTxt" class="center-align">Id Administrador</label>
            <asp:TextBox ID="idAdminTxt" runat="server"></asp:TextBox>
        </div>
    </div>
    <div class="row">
        <div class="input-field col s12">
