<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="actualizarUsuario.aspx.cs" Inherits="actualizarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoContent" Runat="Server">
    ...
    <div class="row">
        <div class="input-field col s12">
            <label for="idUserTxT" class="center-align">Ingresar id del usuario a editar</label>
