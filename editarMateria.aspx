<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="editarMateria.aspx.cs" Inherits="editarMateria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoContent" Runat="Server">
    ...
    <div class="row">
        <div class="input-field col s12">
            ...
            <asp:TextBox ID="cantAlumnosTxT" runat="server"></asp:TextBox>
